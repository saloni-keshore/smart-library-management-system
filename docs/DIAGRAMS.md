...
graph TD
    ...
    Root --> Routes["routes/"]
    Root --> Panda["panda/ (self-contained blueprint package, ADR-43)"]
    ...
    Panda --> PandaFiles["routes.py, services.py, prompts.py, notifications.py, insights.py, forecasting.py — the 15th blueprint"]
...
graph LR
    ...
    subgraph Panda["panda/"]
        ...
        panda_forecasting_py["forecasting.py (unreachable stub, no edges in/out)"]
    end
