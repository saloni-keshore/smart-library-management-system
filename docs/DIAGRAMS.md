...
sequenceDiagram
    ...
    alt not logged in
        ...
        same helper instead of each inlining this sequence
            ...
            Q->>S: INSERT INTO audit_log (Supabase — direct write, ADR-22; SQLite mirror-write removed, ADR-26)
