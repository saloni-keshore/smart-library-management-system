...
graph TD
    ...
    Enquiries -.->|"SQLite mirror (add/edit/delete) + students lookup, TD-36"| DB
    Student --> DB
    Membership --> DB
    Membership --> CashQ
    ...
    SupabaseClient --> SupabaseDB[("Supabase (PostgreSQL) — admins, enquiries")]
...
graph LR
    ...
    enquiries_py -.->|"SQLite mirror (add/edit/delete) + students lookup, TD-36"| db_py
    student_py --> db_py
