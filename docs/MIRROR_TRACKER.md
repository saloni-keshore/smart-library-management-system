...
**Exact removal conditions:** none remaining — fully removed. `routes/setting.py`'s `backup_create()` whole-file SQLite copy is unaffected (it copies the file, not a live query) and remains a Phase 11 concern.
