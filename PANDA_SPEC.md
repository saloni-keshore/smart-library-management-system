...
Panda does **not** currently read: Payments detail, Cashbook entries themselves beyond the above (this month's expense-vs-income ratio and the all-time expense-category breakdown), Marketing/locality data (none exists in the schema), any data beyond 6 months back (Part 5's forecast window), or any monthly (as opposed to all-time) income/expense category breakdown (TD-61).
